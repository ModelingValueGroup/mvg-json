...
class CoercingMemberSetter implements FieldSetter {
    @SuppressWarnings({"FieldCanBeLocal", "unused"})
    private final String      name;
    private final FieldSetter nullFieldSetter;
    private final FieldSetter longFieldSetter;
    private final FieldSetter doubleFieldSetter;
    private final FieldSetter boolFieldSetter;
    private final FieldSetter stringFieldSetter;
    private final FieldSetter objectFieldSetter;

    static FieldSetter forCollection(Type fieldType) {
        Class<?> clazz = U.getRawClassOf(fieldType);
    ...
    static FieldSetter forMap(Type fieldType) {
        Class<?> clazz = U.getRawClassOf(fieldType);
    ...
    static CoercingMemberSetter forField(Field f, boolean ignoreSFO) {
        ...
        FieldSetter longFieldSetter    = null;
        FieldSetter doubleFieldSetter  = null;
        FieldSetter booleanFieldSetter = null;
        FieldSetter stringFieldSetter  = null;
        if (!ignoreSFO) {
            longFieldSetter    = makeConstructorFieldSetter(null, f, long.class, x -> (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, f, int.class, x -> (int) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, f, short.class, x -> (short) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, f, byte.class, x -> (byte) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, f, char.class, x -> (char) (long) x);
            doubleFieldSetter  = makeConstructorFieldSetter(null, f, double.class, x -> (double) x);
            doubleFieldSetter  = makeConstructorFieldSetter(doubleFieldSetter, f, float.class, x -> (float) (double) x);
            booleanFieldSetter = makeConstructorFieldSetter(null, f, boolean.class, x -> (boolean) x);
            stringFieldSetter  = makeConstructorFieldSetter(null, f, String.class, x -> (String) x);
        }
    ...
    static CoercingMemberSetter forMethod(Method m, boolean ignoreSFO) {
        ...
        FieldSetter stringFieldSetter  = null;
        if (!ignoreSFO) {
            longFieldSetter    = makeConstructorFieldSetter(null, m, long.class, x -> (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, m, int.class, x -> (int) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, m, short.class, x -> (short) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, m, byte.class, x -> (byte) (long) x);
            longFieldSetter    = makeConstructorFieldSetter(longFieldSetter, m, char.class, x -> (char) (long) x);
            doubleFieldSetter  = makeConstructorFieldSetter(null, m, double.class, x -> (double) x);
            doubleFieldSetter  = makeConstructorFieldSetter(doubleFieldSetter, m, float.class, x -> (float) (double) x);
            booleanFieldSetter = makeConstructorFieldSetter(null, m, boolean.class, x -> (boolean) x);
            stringFieldSetter  = makeConstructorFieldSetter(null, m, String.class, x -> (String) x);
        }
    ...
    private static <PRIM> FieldSetter makeConstructorFieldSetter(FieldSetter setter, Field f, Class<PRIM> primClass, Function<Object, PRIM> convert) {
    ...
    private static <PRIM> FieldSetter makeConstructorFieldSetter(FieldSetter setter, Method m, Class<PRIM> primClass, Function<Object, PRIM> convert) {
    ...
    CoercingMemberSetter(String name, FieldSetter nullFieldSetter, FieldSetter longFieldSetter, FieldSetter doubleFieldSetter, FieldSetter boolFieldSetter, FieldSetter stringFieldSetter, FieldSetter objectFieldSetter) {
        this.name              = name;
    ...
    public Object set(Object o, Object key, Object v) {
        try {
            ...
            if (valueClass == null) {
                notNull(nullFieldSetter, o, key, null).set(o, key, null);
    ...
    private static FieldSetter notNull(FieldSetter ss, Object o, Object key, Object v) {
        if (ss == null) {
